import { createCourse } from '../../next-firebase-auth/courses'
        ...
        <div className="absolute top-0 flex justify-center items-center min-h-full min-w-full bg-black/50">
          <div className="border rounded-md max-w-lg m-5 p-5 bg-white">
            ...
            <p className="mb-4">
              ...
              alumnos y ofrece un nivel mayor de <span className="text-blue-500">privacidad y seguridad</span>, que tan
              importantes son en el entorno educativo. Los alumnos no pueden usar Google Classroom en un centro
